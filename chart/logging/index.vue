...
<template>
  <div class="logging">
    ...
    <div v-if="provider === 'aks'" class="row mb-20">
      <div class="col span-6">
        <LabeledInput v-model="value.additionalLoggingSources.aks.fluentbit.mountPath" :label="t('logging.install.fluentbitMountPath')" />
      </div>
    </div>
    <div class="row">
      <div class="col span-6">
