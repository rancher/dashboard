...
export function init(store) {
  ...
  headers(WORKLOAD, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, TYPE, 'Ready', AGE]);
  headers(WORKLOAD_TYPES.DEPLOYMENT, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Ready', 'Up-to-date', 'Available', AGE]);
  headers(WORKLOAD_TYPES.DAEMON_SET, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Ready', 'Current', 'Desired', AGE]);
  headers(WORKLOAD_TYPES.REPLICA_SET, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Ready', 'Current', 'Desired', AGE]);
  headers(WORKLOAD_TYPES.STATEFUL_SET, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Ready', AGE]);
  headers(WORKLOAD_TYPES.JOB, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Completions', 'Duration', AGE]);
  headers(WORKLOAD_TYPES.CRON_JOB, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Schedule', 'Last Schedule', AGE]);
  headers(WORKLOAD_TYPES.REPLICATION_CONTROLLER, [STATE, NAMESPACE_NAME, WORKLOAD_IMAGES, 'Ready', 'Current', 'Desired', AGE]);
