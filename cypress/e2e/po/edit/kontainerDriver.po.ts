...
export default class KontainerDriverEditPo extends PagePo {
  ...
  static goTo(clusterId: string, type = 'create'): Cypress.Chainable<Cypress.AUTWindow> {
    return super.goTo(KontainerDriverEditPo.createPath(clusterId, type));
  }

  constructor(clusterId: string, type = 'create') {
    super(KontainerDriverEditPo.createPath(clusterId, type));
  }
