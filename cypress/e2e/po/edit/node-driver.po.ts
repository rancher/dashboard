...
export default class NodeDriverCreateEditPo extends PagePo {
  private static createPath(clusterId: string) {
    return `/c/${ clusterId }/manager/nodeDriver/create`;
  }

  static goTo(clusterId: string): Cypress.Chainable<Cypress.AUTWindow> {
    return super.goTo(NodeDriverCreateEditPo.createPath(clusterId));
  }

  constructor(clusterId = '_') {
    super(NodeDriverCreateEditPo.createPath(clusterId));
  }
