...
export default class NodeDriverEditPo extends PagePo {
  ...
  static goTo(clusterId: string, type = 'create'): Cypress.Chainable<Cypress.AUTWindow> {
    return super.goTo(NodeDriverEditPo.createPath(clusterId, type));
  }

  constructor(clusterId: string, type = 'create') {
    super(NodeDriverEditPo.createPath(clusterId, type));
  }
