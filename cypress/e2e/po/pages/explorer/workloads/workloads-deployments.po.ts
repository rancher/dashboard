...
export class WorkloadsDeploymentsDetailsPagePo extends workloadDetailsPageBasePo {
  ...
  constructor(workloadId: string, protected clusterId: string = 'local', workloadType: string = 'apps.deployment', namespaceId = 'default', queryParams?: { [key: string]: string }) {
...
export class WorkloadsDeploymentsListPagePo extends WorkloadsListPageBasePo {
  ...
  constructor(protected clusterId: string = 'local', workloadType: string = 'apps.deployment', queryParams?: { [key: string]: string }) {
