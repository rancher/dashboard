...
describe.skip('Charts Install', { tags: ['@charts', '@adminUser'] }, () => {
  describe.skip('Question tabs', () => {
    beforeEach(() => {
      cy.login();
      HomePagePo.goTo();
    });
    ...
    describe.skip('Vsphere Cpi chart install - Tabs visibility', () => {
    ...
    describe.skip('NeuVector chart install - Tabs visibility', () => {
