...
describe('Settings', () => {
  // This test needs updating to leave rancher in the same state it was before starting
  // At the moment it assumes original values... which are sometimes wrong and thus change behaviour
  it('disabled', () => {});
});
...
//         settingsOriginal[0].metadata.resourceVersion = response.resourceVersion;
//         cy.setRancherResource('v1', 'management.cattle.io.settings', 'server-url', settingsOriginal[0]);
//       });
//     }
//   });
// });
