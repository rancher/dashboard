...
describe('User can update their preferences', () => {
  ...
  it('Can navigate to Preferences Page', { tags: ['@userMenu', '@admin', '@standardUser', '@flaky'] }, () => {
    /*
  ...
  it('Can select a language', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select language
    */
    const languages = {
  ...
  it('Can select a theme', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
  ...
  it('Can select login landing page', { tags: ['@userMenu', '@admin'] }, () => {
    /*
  ...
  it('Can select date format', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select each option
    Validate http request's payload & response contain correct values per selection
    */
  ...
  it('Can select time format', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select each option
    Validate http request's payload & response contain correct values per selection
    */
  ...
  it('Can select Table Rows per Page', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select each option
    Validate http request's payload & response contain correct values per selection
    */
  ...
  it('Can select Confirmation Setting', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select the checkbox
    Validate http request's payload & response contain correct values per selection
    */
  ...
  it('Can select Enable "View in API"', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
  ...
  it('Can select Show system Namespaces managed by Rancher (not intended for editing or deletion)', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
  ...
  it('Can select Enable Dark/Light Theme keyboard shortcut toggle (shift+T)', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
    Select checkbox option
    Validate http request's payload & response contain correct values per selection
    */
  ...
  it('Can select Hide All Type Description Boxes', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
  ...
  it('Can select a YAML Editor Key Mapping option', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
  ...
  it('Can select a Helm Charts option', { tags: ['@userMenu', '@admin', '@standardUser'] }, () => {
    /*
