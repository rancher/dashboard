...
describe('Rancher setup', { tags: ['@adminUserSetup', '@standardUserSetup', '@setup', '@navigation', '@charts', '@elemental', '@explorer', '@extensions', '@fleet', '@generic', '@globalSettings', '@manager', '@userMenu', '@usersAndAuths'] }, () => {
