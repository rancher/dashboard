...
declare global {
  namespace Cypress {
    ...
    interface Chainable {
      ...
      waitForStableFilteredResourceCount(prefix: 'v3' | 'v1', resourceType: string, namespaces: string[], config?: { stableReads?: number, maxReads?: number, intervalMs?: number }): Chainable<number>;
