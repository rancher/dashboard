...
send_jenkins_e2e_failure_notification() {
    ...
    # TODO: NEEDS UPDATE. Currently using a test Slack bot token and channel
    local slack_bot_token="${UI_SLACK_BOT_TOKEN:-${UI_SLACK_BOT_TOKEN_TESTING:-}}"
    local slack_channel="${UI_SLACK_CHANNEL:-${UI_SLACK_CHANNEL_TESTING:-}}"
