...
In order to provision a cluster, we need to provide a [cloud credential](../cloud-credential.md), identically to a node driver, and a main [component](./components.md) declared in provisioner.ts.
```ts
