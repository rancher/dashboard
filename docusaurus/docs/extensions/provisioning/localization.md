...
3.  Add a key `cluster.provider.<your-provider-id>` with the desired display name. This is the key Rancher checks for when displaying providers cards inside cluster creation wizard.
