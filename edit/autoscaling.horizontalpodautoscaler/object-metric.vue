...
import MetricIdentifier from '@/edit/autoscaling.horizontalpodautoscaler/metric-identifier';
import MetricObjectReference from '@/edit/autoscaling.horizontalpodautoscaler/metric-object-reference';
