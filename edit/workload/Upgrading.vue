          ...
          >
            <template #label>
              <label class="has-tooltip" :style="{'color':'var(--input-label)'}">
                ...
                <i v-tooltip="t('workload.upgrading.maxSurge.tip')" class="icon icon-info" />
              </label>
            </template>
          </InputWithSelect>
        </div>
          ...
          >
            <template #label>
              <label class="has-tooltip" :style="{'color':'var(--input-label)'}">
                ...
                <i v-tooltip="t('workload.upgrading.maxUnavailable.tip')" class="icon icon-info" />
              </label>
            </template>
          </InputWithSelect>
        </div>
        ...
        <UnitInput v-model="minReadySeconds" :suffix="minReadySeconds == 1 ? 'Second' : 'Seconds'" :label="t('workload.upgrading.minReadySeconds.label')" :mode="mode">
          <template #label>
            <label class="has-tooltip" :style="{'color':'var(--input-label)'}">
              ...
              <i v-tooltip="t('workload.upgrading.minReadySeconds.tip')" class="icon icon-info" />
            </label>
          </template>
        </UnitInput>
      </div>
        ...
        <UnitInput v-model="revisionHistoryLimit" :suffix="revisionHistoryLimit == 1 ? 'Set' : 'Sets'" :label="t('workload.upgrading.revisionHistoryLimit.label')" :mode="mode">
          <template #label>
            <label class="has-tooltip" :style="{'color':'var(--input-label)'}">
              ...
              <i v-tooltip="t('workload.upgrading.revisionHistoryLimit.tip')" class="icon icon-info" />
            </label>
          </template>
        </UnitInput>
      </div>
        ...
        <UnitInput v-model="progressDeadlineSeconds" :suffix="progressDeadlineSeconds == 1 ? 'Second' : 'Seconds'" label="Progress Deadline" :mode="mode">
          <template #label>
            <label class="has-tooltip" :style="{'color':'var(--input-label)'}">
              ...
              <i v-tooltip="t('workload.upgrading.progressDeadlineSeconds.tip')" class="icon icon-info" />
            </label>
          </template>
        </UnitInput>
      </div>
