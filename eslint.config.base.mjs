...
export const eslintConfigBase = [
  ...
  // override: RcSeparator.vue is the sanctioned wrapper around <hr> (was `.eslintrc.default.js` overrides[0])
  {
  ...
  // override: test files — jest recommended + jest globals (was overrides[2])
  {
    files:           testFiles,
