...
<template>
  <div v-if="typeOption" class="row">
    <Select class="mr-10 resource-type" :mode="mode" :value="type" :options="types" @input="updateType($event)" />
    <UnitInput
...
<style lang='scss' scoped>
  .row {
    ...
    .resource-type {
      min-height: $input-height; // Match height of UnitInput (see labeled-input)
    }
  }
</style>
