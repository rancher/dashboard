...
.cluster-switcher-row {
  ...
  .row-badge {
    ...
    // Pinned-ness is shown by the row's pin toggle, so ClusterIconMenu's pin overlay on the chip is
    // redundant in the flyout — hide it. SURE-8192 (v2).
    :deep(.cluster-pin-icon) {
      display: none;
    }
  }
