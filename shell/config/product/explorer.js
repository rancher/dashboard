...
export function init(store) {
  ...
  // Gateway API CRDs. Registering headers does not add the type to the nav, it only replaces the
  // raw printer columns Steve falls back to, both here and on the workload's HTTPRoutes tab.
