...
export function init(store) {
  ...
  headers(CAPI.MACHINE, [STATE, NAME_COL, NAMESPACE_COL, AGE], [STEVE_STATE_COL, STEVE_NAME_COL, STEVE_NAMESPACE_COL, STEVE_AGE_COL]);
  headers(CAPI.MACHINESET, [STATE, NAME_COL, NAMESPACE_COL, AGE], [STEVE_STATE_COL, STEVE_NAME_COL, STEVE_NAMESPACE_COL, STEVE_AGE_COL]);
