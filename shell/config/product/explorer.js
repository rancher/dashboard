...
export function init(store) {
  ...
  const dePaginateSteveUsers = configureConditionalDepaginate({ maxResourceCount: 5000, isNorman: true });
  ...
  configureType(MANAGEMENT.USER, { depaginate: dePaginateSteveUsers });
