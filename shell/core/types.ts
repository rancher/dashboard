...
export type PluginRouteConfig = {parent?: string, route: RouteRecordRaw}
...
export interface ConfigureVirtualTypeOptions extends ConfigureTypeOptions {
  ...
  /**
   * The route that this type should correspond to {@link PluginRouteConfig} {@link RouteRecordRaw}
   */
  route: PluginRouteConfig | RouteRecordRaw | Object;
}
...
export interface IPlugin {
   ...
   */
  addRoutes(routes: PluginRouteConfig[] | RouteRecordRaw[]): void;
