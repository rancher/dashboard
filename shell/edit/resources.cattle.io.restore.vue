...
export default {
  ...
  async fetch() {
    const hash = await allHash({
      ...
      resourceSet: this.$store.dispatch('cluster/find', { type: BACKUP_RESTORE.RESOURCE_SET, id: this.value?.spec?.resourceSetName || 'rancher-resource-set-basic' || 'rancher-resource-set-full' }),
