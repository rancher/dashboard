...
export async function installInjectedPlugins(app, vueApp) {
  const pluginDefinitions = [config, axios, initUiApis, pluginsLoader, axiosShell, intNumber, codeMirror, nuxtClientInit, replaceAll, plugin, steveCreateWorker, emberCookie, dynamicContent];
