...
export default {
  ...
  computed: {
    ...
    createLabel() {
      ...
      } else if (this.activeTab === CONFIG_MAP_SCOPED_TABS.NAMESPACED) {
        return this.t('configmaps.tabs.namespaced.create');
      } else if (this.activeTab === CONFIG_MAP_SCOPED_TABS.PROJECT_SCOPED) {
        return this.t('configmaps.tabs.projectScoped.create');
      }
  ...
  <div v-else>
    ...
    >
      <Tab
        ...
        :name="CONFIG_MAP_SCOPED_TABS.NAMESPACED"
        :weight="1"
      >
        <ResourceTable
          :schema="schema"
      ...
      <Tab
        ...
        :name="CONFIG_MAP_SCOPED_TABS.PROJECT_SCOPED"
      >
        <ResourceTable
          :schema="schema"
