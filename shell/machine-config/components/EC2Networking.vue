...
export default {
  ...
  emits: ['update:enablePrimaryIpv6', 'update:ipv6AddressCount', 'update:ipv6AddressOnly', 'update:vpcId', 'update:subnetId', 'validationChanged'],
  ...
  watch: {
    ...
    ipv6Selected(neu) {
      if (neu) {
        this.$emit('update:ipv6AddressOnly', true);
      }
    },
