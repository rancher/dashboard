...
type Namespaces = Parameters<(typeof stevePaginationUtils)['handlePrefAndSettingFilter']>[0]['allNamespaces'];
...
describe('class: NamespaceProjectFilters', () => {
  ...
  const allNamespaces = [normalNs, obscureNs, systemNs, obscureAndSystemNs] as unknown as Namespaces;
...
describe('class StevePaginationUtils', () => {
  ...
  describe('method: createParamsFromNsFilter', () => {
    ...
    const allNamespaces = [normalNs, obscureNs, systemNs] as unknown as Namespaces;
