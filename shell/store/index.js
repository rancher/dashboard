...
export const actions = {
  ...
  async loadCluster({
    ...
    //  AND if the product not scoped to the explorer (a case for products that only exist within the explorer)
    if ( ( (state.clusterId && id) || !samePackage ) && !productConfig?.inExplorer ) {
